...
describe('UnicodeConverter.vue', () => {
  ...
  describe('複製與貼上', () => {
    ...
    it('應能複製編碼結果', async () => {
      ...
      const copyButtons = wrapper.findAll('.copy-btn-overlay');
      expect(copyButtons).toHaveLength(2);
      const outputCopyButton = copyButtons.at(1);
      expect(outputCopyButton).toBeDefined();
